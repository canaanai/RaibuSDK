...
/**
 * @author chenp
 * @version 2017-03-03 17:15
 */

public class AntiqueEffect extends Effect {
    private static final String EFFECT_VERTEX = "shaders/vertexs/vertexshader.glsl";
    private static final String EFFECT_FRAGMENT = "shaders/fragments/antique.glsl";

    private int[] mToneCurveTexture = {-1};
    private int mToneCurveTextureUniformLocation;

    public AntiqueEffect(Context context){
        super();
